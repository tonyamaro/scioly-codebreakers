...
public class Runner {
    ...
    public static void main(String[] a) {
        ...
        Cypher key1Cypher = new Cypher(Language.ENGLISH,
                        "Two things are infinite: the universe and human stupidity; and I'm not sure about the universe.",
                        new KnKeyMaker(KnKeyMaker.KModel.K1, "EINSTEIN"));
        System.out.println(Formatter.ARISTOCRAT.format(key1Cypher));

        key1Cypher = new Cypher(Language.ENGLISH,
        ...
        System.out.println(Formatter.PATRISTOCRAT.format(key1Cypher));
